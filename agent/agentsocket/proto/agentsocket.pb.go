...
const file_agent_agentsocket_proto_agentsocket_proto_rawDesc = "" +
	"\n" +
	")agent/agentsocket/proto/agentsocket.proto\x12\x14coder.agentsocket.v1\x1a\x17agent/proto/agent.proto\"\r\n" +
	"\vPingRequest\"\x0e\n" +
	"\fPingResponse\"&\n" +
	...
	"\fdependencies\x18\x03 \x03(\v2$.coder.agentsocket.v1.DependencyInfoR\fdependencies2\x9f\x05\n" +
	"\vAgentSocket\x12M\n" +
	...
	"\n" +
	"SyncStatus\x12'.coder.agentsocket.v1.SyncStatusRequest\x1a(.coder.agentsocket.v1.SyncStatusResponse\x12b\n" +
	"\x0fUpdateAppStatus\x12&.coder.agent.v2.UpdateAppStatusRequest\x1a'.coder.agent.v2.UpdateAppStatusResponseB3Z1github.com/coder/coder/v2/agent/agentsocket/protob\x06proto3"
