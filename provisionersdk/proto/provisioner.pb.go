...
func (x *Agent) GetAuth() isAgent_Auth {
	if x != nil {
		return x.Auth
	}
	return nil
...
func (x *Agent) GetInstanceId() string {
	if x != nil {
		if x, ok := x.Auth.(*Agent_InstanceId); ok {
			return x.InstanceId
		}
	}
	return ""
...
func (x *Devcontainer) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *Devcontainer) GetSubagentId() string {
	if x != nil {
		return x.SubagentId
	}
	return ""
...
type ParseComplete struct {
	...
	WorkspaceTags     map[string]string      `protobuf:"bytes,4,rep,name=workspace_tags,json=workspaceTags,proto3" json:"workspace_tags,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Request) GetConfig() *Config {
	if x != nil {
		if x, ok := x.Type.(*Request_Config); ok {
			return x.Config
		}
	}
	return nil
...
func (x *Request) GetParse() *ParseRequest {
	if x != nil {
		if x, ok := x.Type.(*Request_Parse); ok {
			return x.Parse
		}
	}
	return nil
...
func (x *Request) GetCancel() *CancelRequest {
	if x != nil {
		if x, ok := x.Type.(*Request_Cancel); ok {
			return x.Cancel
		}
	}
	return nil
...
func (x *Request) GetFile() *FileUpload {
	if x != nil {
		if x, ok := x.Type.(*Request_File); ok {
			return x.File
		}
	}
	return nil
...
func (x *Response) GetLog() *Log {
	if x != nil {
		if x, ok := x.Type.(*Response_Log); ok {
			return x.Log
		}
	}
	return nil
...
func (x *Response) GetParse() *ParseComplete {
	if x != nil {
		if x, ok := x.Type.(*Response_Parse); ok {
			return x.Parse
		}
	}
	return nil
...
func (x *Response) GetDataUpload() *DataUpload {
	if x != nil {
		if x, ok := x.Type.(*Response_DataUpload); ok {
			return x.DataUpload
		}
	}
	return nil
...
func (x *Response) GetChunkPiece() *ChunkPiece {
	if x != nil {
		if x, ok := x.Type.(*Response_ChunkPiece); ok {
			return x.ChunkPiece
		}
	}
	return nil
...
func (x *FileUpload) GetType() isFileUpload_Type {
	if x != nil {
		return x.Type
	}
	return nil
...
func (x *FileUpload) GetDataUpload() *DataUpload {
	if x != nil {
		if x, ok := x.Type.(*FileUpload_DataUpload); ok {
			return x.DataUpload
		}
	}
	return nil
...
func (x *FileUpload) GetChunkPiece() *ChunkPiece {
	if x != nil {
		if x, ok := x.Type.(*FileUpload_ChunkPiece); ok {
			return x.ChunkPiece
		}
	}
	return nil
...
func (x *FileUpload) GetError() *FailedFile {
	if x != nil {
		if x, ok := x.Type.(*FileUpload_Error); ok {
			return x.Error
		}
	}
	return nil
...
const file_provisionersdk_proto_provisioner_proto_rawDesc = "" +
	"\n" +
	...
	"\blog_path\x18\t \x01(\tR\alogPath\"\x9a\x02\n" +
	"\fDevcontainer\x12)\n" +
	...
	"subagentId\x12$\n" +
	"\x04apps\x18\x06 \x03(\v2\x10.provisioner.AppR\x04apps\x12-\n" +
	"\ascripts\x18\a \x03(\v2\x13.provisioner.ScriptR\ascripts\x12$\n" +
	"\x04envs\x18\b \x03(\v2\x10.provisioner.EnvR\x04envs\"\xd4\x03\n" +
	"\x03App\x12\x12\n" +
	...
	"taskPrompt\x12.\n" +
	"\x13template_version_id\x18\x18 \x01(\tR\x11templateVersionId\x12A\n" +
	"\x1dtemplate_version_modules_file\x18\x19 \x01(\tR\x1atemplateVersionModulesFile\"\xc5\x01\n" +
	"\x06Config\x122\n" +
	...
	"\x13template_version_id\x18\x03 \x01(\tH\x01R\x11templateVersionId\x88\x01\x01B\x0e\n" +
	"\f_template_idB\x16\n" +
	"\x14_template_version_idJ\x04\b\x04\x10\x05\"\x0e\n" +
	...
	"\x11omit_module_files\x18\x03 \x01(\bR\x0fomitModuleFiles\x125\n" +
	"\x17initial_module_tar_hash\x18\x04 \x01(\fR\x14initialModuleTarHash\"\xd1\x01\n" +
	...
	"\rai_task_count\x18\x06 \x01(\x05R\vaiTaskCount\"A\n" +
	"\fApplyRequest\x121\n" +
	"\bmetadata\x18\x01 \x01(\v2\x15.provisioner.MetadataR\bmetadata\"j\n" +
	...
	"\x06cancel\x18\a \x01(\v2\x1a.provisioner.CancelRequestH\x00R\x06cancel\x12-\n" +
	"\x04file\x18\b \x01(\v2\x17.provisioner.FileUploadH\x00R\x04fileB\x06\n" +
	"\x04type\"\xae\x03\n" +
	"\bResponse\x12$\n" +
	...
	"chunkPiece\x12/\n" +
	"\x05error\x18\x03 \x01(\v2\x17.provisioner.FailedFileH\x00R\x05errorB\x06\n" +
	"\x04type\"\"\n" +
	"\n" +
	"FailedFile\x12\x14\n" +
	"\x05error\x18\x01 \x01(\tR\x05error\"\x9c\x01\n" +
	"\n" +
	"DataUpload\x12<\n" +
	...
	"\vProvisioner\x12:\n" +
	"\aSession\x12\x14.provisioner.Request\x1a\x15.provisioner.Response(\x010\x01B0Z.github.com/coder/coder/v2/provisionersdk/protob\x06proto3"

var (
	file_provisionersdk_proto_provisioner_proto_rawDescOnce sync.Once
	file_provisionersdk_proto_provisioner_proto_rawDescData []byte
)
...
func file_provisionersdk_proto_provisioner_proto_init() {
	...
	file_provisionersdk_proto_provisioner_proto_msgTypes[49].OneofWrappers = []any{
