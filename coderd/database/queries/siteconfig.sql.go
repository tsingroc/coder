...
func (q *Queries) GetChatDesktopEnabled(ctx context.Context) (bool, error) {
...
func (q *Queries) GetChatSystemPrompt(ctx context.Context) (string, error) {
...
func (q *Queries) GetChatWorkspaceTTL(ctx context.Context) (string, error) {
...
func (q *Queries) UpsertChatDesktopEnabled(ctx context.Context, enableDesktop bool) error {
...
func (q *Queries) UpsertChatSystemPrompt(ctx context.Context, value string) error {
...
func (q *Queries) UpsertChatWorkspaceTTL(ctx context.Context, workspaceTtl string) error {
