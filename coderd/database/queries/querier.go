...
type Querier interface {
	...
	DeleteTemplateQuotaDefault(ctx context.Context, templateID uuid.UUID) error
	...
	DeleteUserTemplateQuota(ctx context.Context, arg DeleteUserTemplateQuotaParams) error
	...
	GetAllTemplateQuotaDefaults(ctx context.Context) ([]GetAllTemplateQuotaDefaultsRow, error)
	// Get all user custom quota overrides with user and template info
	GetAllUserQuotaOverrides(ctx context.Context) ([]GetAllUserQuotaOverridesRow, error)
	// Get all custom quotas for a specific user across all templates
	GetAllUserTemplateQuotas(ctx context.Context, userID uuid.UUID) ([]UserTemplateQuota, error)
	...
	GetTemplateQuotaDefault(ctx context.Context, templateID uuid.UUID) (TemplateQuotaDefault, error)
	// Get workspace usage breakdown per template for a specific user
	GetTemplateUsageByUser(ctx context.Context, ownerID uuid.UUID) ([]GetTemplateUsageByUserRow, error)
	...
	GetUserTemplateQuota(ctx context.Context, arg GetUserTemplateQuotaParams) (UserTemplateQuota, error)
	...
	GetUserWorkspaceCountByTemplate(ctx context.Context, arg GetUserWorkspaceCountByTemplateParams) (int64, error)
	...
	SetTemplateQuotaDefault(ctx context.Context, arg SetTemplateQuotaDefaultParams) (TemplateQuotaDefault, error)
	// Set or update a user's quota for a specific template
	SetUserTemplateQuota(ctx context.Context, arg SetUserTemplateQuotaParams) (UserTemplateQuota, error)
