...
const deleteTemplateQuotaDefault = `-- name: DeleteTemplateQuotaDefault :exec
DELETE FROM template_quota_defaults
WHERE template_id = $1
`

// Delete the default quota for a specific template
func (q *Queries) DeleteTemplateQuotaDefault(ctx context.Context, templateID uuid.UUID) error {
	_, err := q.db.ExecContext(ctx, deleteTemplateQuotaDefault, templateID)
	return err
}

const deleteUserTemplateQuota = `-- name: DeleteUserTemplateQuota :exec
DELETE FROM user_template_quotas
WHERE user_id = $1 AND template_id = $2
`

type DeleteUserTemplateQuotaParams struct {
	UserID     uuid.UUID `db:"user_id" json:"user_id"`
	TemplateID uuid.UUID `db:"template_id" json:"template_id"`
}

// Delete a user's custom quota for a specific template (reverts to default)
func (q *Queries) DeleteUserTemplateQuota(ctx context.Context, arg DeleteUserTemplateQuotaParams) error {
	_, err := q.db.ExecContext(ctx, deleteUserTemplateQuota, arg.UserID, arg.TemplateID)
	return err
}
...
func (q *Queries) DeleteWorkspaceACLByID(ctx context.Context, id uuid.UUID) error {
...
func (q *Queries) DeleteWorkspaceACLsByOrganization(ctx context.Context, arg DeleteWorkspaceACLsByOrganizationParams) error {
...
const getAllTemplateQuotaDefaults = `-- name: GetAllTemplateQuotaDefaults :many
SELECT
    tqd.template_id,
    tqd.default_quota,
    tqd.updated_at,
...
type GetAllTemplateQuotaDefaultsRow struct {
	TemplateID          uuid.UUID     `db:"template_id" json:"template_id"`
	DefaultQuota        int32         `db:"default_quota" json:"default_quota"`
...
func (q *Queries) GetAllTemplateQuotaDefaults(ctx context.Context) ([]GetAllTemplateQuotaDefaultsRow, error) {
	rows, err := q.db.QueryContext(ctx, getAllTemplateQuotaDefaults)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []GetAllTemplateQuotaDefaultsRow
	for rows.Next() {
		var i GetAllTemplateQuotaDefaultsRow
		if err := rows.Scan(
			&i.TemplateID,
			&i.DefaultQuota,
			&i.UpdatedAt,
...
const getAllUserQuotaOverrides = `-- name: GetAllUserQuotaOverrides :many
SELECT
    u.id as user_id,
    u.username,
    u.email,
...
type GetAllUserQuotaOverridesRow struct {
	UserID              uuid.UUID `db:"user_id" json:"user_id"`
	...
	TemplateDisplayName string    `db:"template_display_name" json:"template_display_name"`
	TemplateIcon        string    `db:"template_icon" json:"template_icon"`
	WorkspaceQuota      int32     `db:"workspace_quota" json:"workspace_quota"`
	UpdatedAt           time.Time `db:"updated_at" json:"updated_at"`
}

// Get all user custom quota overrides with user and template info
func (q *Queries) GetAllUserQuotaOverrides(ctx context.Context) ([]GetAllUserQuotaOverridesRow, error) {
	rows, err := q.db.QueryContext(ctx, getAllUserQuotaOverrides)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []GetAllUserQuotaOverridesRow
	for rows.Next() {
		var i GetAllUserQuotaOverridesRow
		if err := rows.Scan(
			&i.UserID,
			&i.Username,
			&i.Email,
...
const getAllUserTemplateQuotas = `-- name: GetAllUserTemplateQuotas :many
SELECT
    user_id,
    template_id,
    workspace_quota,
...
func (q *Queries) GetAllUserTemplateQuotas(ctx context.Context, userID uuid.UUID) ([]UserTemplateQuota, error) {
	rows, err := q.db.QueryContext(ctx, getAllUserTemplateQuotas, userID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []UserTemplateQuota
	for rows.Next() {
		var i UserTemplateQuota
		if err := rows.Scan(
			&i.UserID,
			&i.TemplateID,
			&i.WorkspaceQuota,
...
func (q *Queries) GetRegularWorkspaceCreateMetrics(ctx context.Context) ([]GetRegularWorkspaceCreateMetricsRow, error) {
...
const getTemplateQuotaDefault = `-- name: GetTemplateQuotaDefault :one
SELECT
    template_id,
    default_quota,
    updated_at,
...
func (q *Queries) GetTemplateQuotaDefault(ctx context.Context, templateID uuid.UUID) (TemplateQuotaDefault, error) {
	row := q.db.QueryRowContext(ctx, getTemplateQuotaDefault, templateID)
	var i TemplateQuotaDefault
	err := row.Scan(
		&i.TemplateID,
		&i.DefaultQuota,
		&i.UpdatedAt,
...
const getTemplateUsageByUser = `-- name: GetTemplateUsageByUser :many
SELECT
    w.template_id,
    t.name as template_name,
    t.display_name as template_display_name,
...
type GetTemplateUsageByUserRow struct {
	TemplateID          uuid.UUID `db:"template_id" json:"template_id"`
	TemplateName        string    `db:"template_name" json:"template_name"`
	TemplateDisplayName string    `db:"template_display_name" json:"template_display_name"`
	TemplateIcon        string    `db:"template_icon" json:"template_icon"`
...
func (q *Queries) GetTemplateUsageByUser(ctx context.Context, ownerID uuid.UUID) ([]GetTemplateUsageByUserRow, error) {
	rows, err := q.db.QueryContext(ctx, getTemplateUsageByUser, ownerID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []GetTemplateUsageByUserRow
	for rows.Next() {
		var i GetTemplateUsageByUserRow
		if err := rows.Scan(
			&i.TemplateID,
			&i.TemplateName,
			&i.TemplateDisplayName,
...
const getUserTemplateQuota = `-- name: GetUserTemplateQuota :one
SELECT
    user_id,
    template_id,
    workspace_quota,
...
type GetUserTemplateQuotaParams struct {
	UserID     uuid.UUID `db:"user_id" json:"user_id"`
	TemplateID uuid.UUID `db:"template_id" json:"template_id"`
}

// Get the custom quota for a specific user-template combination
func (q *Queries) GetUserTemplateQuota(ctx context.Context, arg GetUserTemplateQuotaParams) (UserTemplateQuota, error) {
	row := q.db.QueryRowContext(ctx, getUserTemplateQuota, arg.UserID, arg.TemplateID)
	var i UserTemplateQuota
	err := row.Scan(
		&i.UserID,
		&i.TemplateID,
...
const getUserWorkspaceCountByTemplate = `-- name: GetUserWorkspaceCountByTemplate :one
SELECT
    COUNT(*)
FROM
    workspaces
...
type GetUserWorkspaceCountByTemplateParams struct {
	OwnerID    uuid.UUID `db:"owner_id" json:"owner_id"`
	TemplateID uuid.UUID `db:"template_id" json:"template_id"`
}

// Get the count of workspaces a user has created using a specific template
func (q *Queries) GetUserWorkspaceCountByTemplate(ctx context.Context, arg GetUserWorkspaceCountByTemplateParams) (int64, error) {
	row := q.db.QueryRowContext(ctx, getUserWorkspaceCountByTemplate, arg.OwnerID, arg.TemplateID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) GetWorkspaceACLByID(ctx context.Context, id uuid.UUID) (GetWorkspaceACLByIDRow, error) {
...
func (q *Queries) GetWorkspacesForWorkspaceMetrics(ctx context.Context) ([]GetWorkspacesForWorkspaceMetricsRow, error) {
...
const setTemplateQuotaDefault = `-- name: SetTemplateQuotaDefault :one
...
RETURNING template_id, default_quota, updated_at, updated_by
`

type SetTemplateQuotaDefaultParams struct {
	TemplateID   uuid.UUID     `db:"template_id" json:"template_id"`
	DefaultQuota int32         `db:"default_quota" json:"default_quota"`
	UpdatedBy    uuid.NullUUID `db:"updated_by" json:"updated_by"`
}
...
func (q *Queries) SetTemplateQuotaDefault(ctx context.Context, arg SetTemplateQuotaDefaultParams) (TemplateQuotaDefault, error) {
	row := q.db.QueryRowContext(ctx, setTemplateQuotaDefault, arg.TemplateID, arg.DefaultQuota, arg.UpdatedBy)
	var i TemplateQuotaDefault
	err := row.Scan(
		&i.TemplateID,
		&i.DefaultQuota,
...
const setUserTemplateQuota = `-- name: SetUserTemplateQuota :one
...
type SetUserTemplateQuotaParams struct {
	UserID         uuid.UUID     `db:"user_id" json:"user_id"`
	TemplateID     uuid.UUID     `db:"template_id" json:"template_id"`
	WorkspaceQuota int32         `db:"workspace_quota" json:"workspace_quota"`
	UpdatedBy      uuid.NullUUID `db:"updated_by" json:"updated_by"`
...
func (q *Queries) SetUserTemplateQuota(ctx context.Context, arg SetUserTemplateQuotaParams) (UserTemplateQuota, error) {
	row := q.db.QueryRowContext(ctx, setUserTemplateQuota,
		arg.UserID,
		arg.TemplateID,
		arg.WorkspaceQuota,
		arg.UpdatedBy,
...
func (q *Queries) UpdateWorkspaceACLByID(ctx context.Context, arg UpdateWorkspaceACLByIDParams) error {
